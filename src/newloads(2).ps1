...
# Determine if we should skip CmdletBinding and param blocks
$skipCmdletBinding = Test-ScriptExecution
return $skipCmdletBinding

<# If running via irm | iex, skip CmdletBinding and param
if (-not $skipCmdletBinding) {}
#>
...
#>
	...
	if ($PSCmdlet.ShouldProcess("Optimize-Performance", "Optimize on Performance")) {
...
try {
	...
	Import-Module CimCmdlets -Verbose
	Import-Module ScheduledTasks -Verbose
	Import-Module PrintManagement -Verbose
	Import-Module DnsClient -Verbose
} catch {
